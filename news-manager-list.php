...
<?php
try{
$readdb = $conn->query("select * from news");
...
<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModal<?php echo $information->id ?>"><i class="bi bi-trash3"></i></button>
...
$rejister_form = $conn->prepare("DELETE FROM news WHERE id = :id ");
