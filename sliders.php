...
<?php
try{
$readdb = $conn->query("select * from sliders order by id desc");
...
<tr>
<td><img src="<?php echo $information->image_path ?>" class="w-100 rounded"></td>
<td>
...
$rejister_form = $conn->prepare("DELETE FROM sliders WHERE id = :id ");
