...
<?php
try{
$readdb = $conn->query("select * from access");
...
<td><a href="#"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-gear-wide-connected"></i></button></a></td>
<td>
...
$rejister_form = $conn->prepare("DELETE FROM access WHERE id = :id ");
